<?php
/**
 * Plugin Name: demaree.me API Extensions
 * Plugin URI: https://demaree.me
 * Description: REST API extensions for demaree.me
 * Version: 1.0.0
 * Author: David Demaree
 *
 * @package dd-api-extensions
 */
...
add_action( 'rest_api_init', function () {
    // Replace default CORS headers with more permissive ones, god help us
...
function add_excerpt_raw( $object, $field_name, $request ) {
    $response = trim( $object['excerpt']['raw'] );
    return $response;
}

function add_word_count( $object, $field_name, $request ) {
    $clean_text = trim( strip_tags( $object['content']['raw'] ) );
...
//         // Register routes
//         register_rest_route( 'dd/v1', '/posts', [
//             'methods'  => 'GET',
//             'callback' => 'rest_get_posts'
//         ] );

//         // Register routes
//         register_rest_route( 'dd/v1', '/post', [
//             'methods'  => 'GET',
...
//         register_rest_route( 'dd/v1', '/page', [
//             'methods'  => 'GET',
...
//         register_rest_route('dd/v1', '/post/preview', [
//             'methods'  => 'GET',
